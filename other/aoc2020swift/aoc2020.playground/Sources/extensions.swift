...
public func id(name: String = "list") -> Array<Int> {
    do {
...
public func sd(name: String = "list") -> Array<String> {
    do {
        let path = Bundle.main.path(forResource: name, ofType: "")
        let string = try String(contentsOfFile: path!, encoding: String.Encoding.utf8)
...
public func ssd(name: String = "list") -> [[String]] {
    do {
        let path = Bundle.main.path(forResource: name, ofType: "")
        let string = try String(contentsOfFile: path!, encoding: String.Encoding.utf8)
...
public func gd(name: String = "list") -> [Instr] {
    do {
        let path = Bundle.main.path(forResource: name, ofType: "")
        let string = try String(contentsOfFile: path!, encoding: String.Encoding.utf8)
...
public func arrayData(name: String = "list") -> Array<Array<Substring.Element>> {
    do {
        let path = Bundle.main.path(forResource: name, ofType: "")
        let string = try String(contentsOfFile: path!, encoding: String.Encoding.utf8)
        let splitString = string.split(separator: "\n")
